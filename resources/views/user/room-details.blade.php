...
<section class="cs_page_heading cs_primary_bg cs_bg_filed cs_center" data-src="assets/img/ssss.jpg">
    <div class="container">
  ...
  <section>
    ...
    <div class="container">
      <div class="row cs_gap_y_40">
        ...
        <div class="col-lg-6">
          <div class="cs_pl_110">
            <form action="complete-reservation.php" class="cs_book_now_card cs_accent_bg cs_radius_5">
        ...
        <div class="overflow-hidden cs_radius_5">
          <div class="cs_gallery_slider_nav slick-slider">
            <div class="cs_gallery_slider_thumb_mini">
              <img src="assets/img/Deluxe1.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_mini">
              <img src="assets/img/Deluxe2.jpeg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_mini">
              <img src="assets/img/Deluxe3.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_mini">
              <img src="assets/img/Deluxe4.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_mini">
              <img src="assets/img/Deluxe5.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_mini">
              <img src="assets/img/Deluxe6.jpg" alt="Thumb">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="position-relative overflow-hidden cs_radius_5 cs_gallery_hover_show_nav cs_primary_bg">
          <div class="cs_gallery_slider_thumb slick-slider">
            <div class="cs_gallery_slider_thumb_item">
              <img src="assets/img/Deluxe11.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_item">
              <img src="assets/img/Deluxe22.jpeg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_item">
              <img src="assets/img/Deluxe33.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_item">
              <img src="assets/img/Deluxe44.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_item">
              <img src="assets/img/Deluxe55.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_item">
              <img src="assets/img/Deluxe66.jpg" alt="Thumb">
            </div>
          </div>
