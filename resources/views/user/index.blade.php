        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="cs_hero cs_style_1 cs_center text-center position-relative">
                    <figure
                        ...
                        data-src="assets/img/Home_bg_1.jpeg"></figure>
                    <div class="position-relative cs_zindex_3">
                        <div class="cs_hero_text">
                            ...
                            <h1 class="cs_hero_title cs_fs_89 cs_white_color mb-0">We Find The Best Hotels For You
                                <br>Hotel & Resort</h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper-slide">
                <div class="cs_hero cs_style_1 cs_center text-center position-relative">
                    <figure
                        class="cs_swiper_parallax_bg cs_hero_bg cs_bg_filed h-100 w-100 position-absolute top-0 start-0 mb-0"
                        data-src="assets/img/home_bg_2.jpeg"></figure>
                        ...
                        <div class="cs_hero_text">
                            <p
                                ...
                                <img class="cs_hero_subtitle_icon_1 position-absolute start-0"
                                    src="assets/img/icons/star.svg" alt="Star">
                                Your Journey Begins with the Perfect Hotel
                                <img class="cs_hero_subtitle_icon_2 position-absolute end-0"
                                    src="assets/img/icons/star.svg" alt="Star">
                            </p>
                            <h1 class="cs_hero_title cs_fs_89 cs_white_color mb-0"> Discover Your Perfect Stay with us
                                <br>Hotel & Resort</h1>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="cs_about cs_style_1">
            <div class="cs_section_heading cs_style_1 text-center">
                <p class="cs_section_subtitle cs_medium cs_letter_spacing_1 cs_mb_28 cs_mb_lg_15 text-uppercase wow fadeInUp"
                    data-wow-duration="0.8s" data-wow-delay="0.2s">WHY CHOOSE US</p>
                <h2 class="cs_fs_67 cs_mb_45">Curated to match your preferences and desires, our selection includes
                    luxury resorts, exclusive tours, and transfers for an unparalleled experience</h2>
                </a>
            </div>
        </div>
    </div>
...
<section>
    ...
    <div class="container">
        <div class="cs_section_heading cs_style_1 text-center">
            ...
            <h2 class="cs_fs_67 mb-0 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Most Popular Hotels
            </h2>
        </div>
                ...
                @foreach ($hotels as $hotel)
                  <div class="cs_slide">
                    <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                      <a href="{{ route('details.hotel', $hotel->id) }}"
...
<!-- Start Video Section -->
<a href="https://www.youtube.com/embed/ueMPkXu1trw?si=_nTJJPni5-BO-Gqe"
    class="cs_video_block cs_style_1 cs_video_open text-center cs_center position-relative">
    ...
    <div class="cs_video_block_bg h-100 w-100 position-absolute start-0 top-0 cs_bg_filed cs_primary_bg"
        data-src="assets/img/sayedeeshta.jpg"></div>
    ...
    <div class="cs_slider cs_style_1 cs_slider_gap_40">
        <div class="container">
            <div class="cs_testimonial_1_wrap">
                <div class="cs_slider cs_style_1 cs_slider_gap_40 cs_hover_show_arrows">
                    <div class="cs_slider_container position-relative cs_zindex_3"
                         data-autoplay="0"
                         data-loop="1"
                         data-speed="600"
                         data-center="0"
                        ...
                        <div class="cs_slide">
                          <div class="cs_testimonial cs_style_1 text-center position-relative">
                            <div class="position-relative cs_zindex_2">
                              ...
                              <blockquote class="cs_testimonial_blockquote cs_fs_50 cs_primary_font cs_primary_color fst-normal cs_mb_75 cs_mb_lg_30">
                                Super easy to use and found the best hotel deal in minutes! The booking was seamless, and my stay was perfect. Highly recommend!
                              </blockquote>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="cs_slide">
                          <div class="cs_testimonial cs_style_1 text-center position-relative">
                            <div class="position-relative cs_zindex_2">
                              ...
                              <blockquote class="cs_testimonial_blockquote cs_fs_50 cs_primary_font cs_primary_color fst-normal cs_mb_75 cs_mb_lg_30">
                                Great experience! Smooth booking, amazing hotel options, and no hassle at all. Will definitely use this site again!
                              </blockquote>
                        ...
                        <div class="cs_slide">
                          <div class="cs_testimonial cs_style_1 text-center position-relative">
                            <div class="position-relative cs_zindex_2">
                              ...
                              <blockquote class="cs_testimonial_blockquote cs_fs_50 cs_primary_font cs_primary_color fst-normal cs_mb_75 cs_mb_lg_30">
                                Loved it! Fast, reliable, and got the best deal for my trip. Everything went perfectly. 5 stars!
                              </blockquote>
                              <div class="cs_height_75 cs_height_lg_30"></div>
                            </div>
                          </div>
                    ...
                    <!-- ✅ Arrows added here -->
                    <div class="cs_slider_arrow">
                      <button class="cs_slider_prev">‹</button>
                      <button class="cs_slider_next">›</button>
                    </div>
                  </div>

                <div class="cs_testimonial_quote cs_accent_color">
                    <svg width="512" height="379" viewBox="0 0 512 379" fill="none"
                    ...
                    <div class="cs_footer_item">
                        ...
                        <ul class="cs_menu_widget cs_mp0">
                            ...
                            <li class="cs_white_color">Email : <a
                                    href="mailto:info@nextstay.com">info@nextstay.com</a></li>
                        </ul>
                ...
                <div class="cs_footer_grid_item">
                    <div class="cs_footer_item">
                        ...
                        <div class="cs_footer_map cs_primary_bg">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d858.3443999578885!2d32.26693654006353!3d30.62331414425144!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14f8597f201556e7%3A0x9bd6053867337ff3!2sSuez%20Canal%20University!5e0!3m2!1sen!2seg!4v1738436167095!5m2!1sen!2seg"
    ...
    <div class="cs_bottom_footer_wrap">
        <div class="container">
            <div class="cs_bottom_footer position-relative">
                <div class="cs_copyright">Copyright © <span class="cs_copyright_year">2025</span> <a
                        href="#">NextStay</a></div>
