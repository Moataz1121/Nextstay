...
<section class="cs_page_heading cs_primary_bg cs_bg_filed cs_center" data-src="assets/img/dahab-hotel.jpg">
    <div class="container">
      <h1 class="cs_white_color text-center mb-0 cs_fs_67">Seaview Hotel Dahab</h1>
    </div>
  </section>
  ...
  <section>
    ...
    <div class="container">
      <div class="cs_plr_70">
        <h2 class="cs_fs_50 mb-0 text-center">Seaview Hotel Dahab: Nestled in the heart of Dahab, this charming hotel boasts breathtaking views of the Red Sea and the majestic mountains. Each room is elegantly furnished, providing a comfortable stay for guests</h2>
      </div>
    </div>
    <div class="cs_height_80 cs_height_lg_80"></div>
    <div class="container">
        ...
        <div class="col-lg-15">
          <div class="cs_room_details">
            ...
            <ul class="cs_list cs_style_3 cs_mp_0">
              <li><img src="assets/img/icons/facility_icon_1.svg" alt="Icon">King size bed</li>
              <li><img src="assets/img/icons/facility_icon_2.svg" alt="Icon">Personal Locker</li>
              <li><img src="assets/img/icons/facility_icon_3.svg" alt="Icon">Desk</li>
              <li><img src="assets/img/icons/facility_icon_4.svg" alt="Icon">Personal Locker</li>
              <li><img src="assets/img/icons/facility_icon_5.svg" alt="Icon">Air Condition</li>
              <li><img src="assets/img/icons/facility_icon_6.svg" alt="Icon">Minibar</li>
              <li><img src="assets/img/icons/facility_icon_7.svg" alt="Icon">Coffee and tea</li>
              <li><img src="assets/img/icons/facility_icon_8.svg" alt="Icon">Television</li>
              <li><img src="assets/img/icons/facility_icon_9.svg" alt="Icon">Wi Fi</li>
              <li><img src="assets/img/icons/facility_icon_10.svg" alt="Icon">Bathtub</li>
              <li><img src="assets/img/icons/facility_icon_11.svg" alt="Icon">Breakfast</li>
              <li><img src="assets/img/icons/facility_icon_12.svg" alt="Icon">24/7 Room service</li>
            </ul>
          </div>
        </div>
        ...
        <div class="overflow-hidden cs_radius_5">
          <div class="cs_gallery_slider_nav slick-slider">
            <div class="cs_gallery_slider_thumb_mini">
              <img src="assets/img/first11.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_mini">
              <img src="assets/img/first33.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_mini">
              <img src="assets/img/first22.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_mini">
              <img src="assets/img/first44.jpg" alt="Thumb">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="position-relative overflow-hidden cs_radius_5 cs_gallery_hover_show_nav cs_primary_bg">
          <div class="cs_gallery_slider_thumb slick-slider">
            <div class="cs_gallery_slider_thumb_item">
              <img src="assets/img/first1.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_item">
              <img src="assets/img/first3copy.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_item">
              <img src="assets/img/first2copy.jpg" alt="Thumb">
            </div>
            <div class="cs_gallery_slider_thumb_item">
              <img src="assets/img/first4.jpg" alt="Thumb">
            </div>
          </div>
  ...
  <section>
    ...
    <div class="container">
      <div class="row cs_row_gap_50 cs_gap_y_75">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="cs_iconbox cs_style_1">
            <div class="cs_iconbox_icon cs_mb_29"><img src="assets/img/icons/massage.svg" alt="Icon"></div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="cs_iconbox cs_style_1">
            <div class="cs_iconbox_icon cs_mb_29"><img src="assets/img/icons/gym.svg" alt="Icon"></div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="cs_iconbox cs_style_1">
            <div class="cs_iconbox_icon cs_mb_29"><img src="assets/img/icons/briefcase.svg" alt="Icon"></div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="cs_iconbox cs_style_1">
            <div class="cs_iconbox_icon cs_mb_29"><img src="assets/img/icons/dryer.svg" alt="Icon"></div>
            <h3 class="cs_iconbox_title cs_mb_19 cs_fs_38">Laundry Services</h3>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="cs_iconbox cs_style_1">
            <div class="cs_iconbox_icon cs_mb_29"><img src="assets/img/icons/room-service.svg" alt="Icon"></div>
        ...
        <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-variable-width="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="3" data-add-slides="3">
          <div class="cs_slider_wrapper">
            <div class="cs_slide">
              <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                <a href="room-details.php" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                  <img src="assets/img/single-dahab.jpg" alt="Room">
                ...
                <div class="cs_card_info position-relative">
                  <h2 class="cs_card_title cs_fs_50 cs_mb_4"><a href="room-details.php">Single Room</a></h2>
                  <div class="cs_card_price cs_mb_17">
                    <span class="cs_primary_color">From</span>
                    <span class="cs_accent_color cs_fs_38 cs_primary_font">EGP 1800/Night</span>
                  </div>
                  </ul>
                </div>
              </div>
            ...
            <div class="cs_slide">
              <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                <a href="room-details.php" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                  <img src="assets/img/double-dahab.jpg" alt="Room">
                  <span class="cs_card_btn position-absolute cs_zindex_2">
                    <span class="cs_btn cs_style_2 cs_accent_btn cs_medium cs_radius_5 cs_fs_15">
                      <b>Details View</b>
                      <span>
                ...
                <div class="cs_card_info position-relative">
                  <h2 class="cs_card_title cs_fs_50 cs_mb_4"><a href="room-details.php">Double Room</a></h2>
                  <div class="cs_card_price cs_mb_17">
                    <span class="cs_primary_color">From</span>
                    <span class="cs_accent_color cs_fs_38 cs_primary_font">EGP2200/Night</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="cs_slide">
              <div class="cs_card cs_style_7 cs_radius_5 overflow-hidden">
                <a href="room-details.php" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                  <img src="assets/img/triple-dahab.jpg" alt="Room">
                  <span class="cs_card_btn position-absolute cs_zindex_2">
                    <span class="cs_btn cs_style_2 cs_accent_btn cs_medium cs_radius_5 cs_fs_15">
                      <b>Details View</b>
                      <span>
                ...
                <div class="cs_card_info position-relative">
                  <h2 class="cs_card_title cs_fs_50 cs_mb_4"><a href="room-details.php">Triple Room</a></h2>
                  <div class="cs_card_price cs_mb_17">
                    <span class="cs_primary_color">From</span>
                    <span class="cs_accent_color cs_fs_38 cs_primary_font">EGP 2700/Night</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="cs_slide">
                <a href="room-details.php" class="cs_card_thumb d-block overflow-hidden position-relative cs_primary_bg">
                  <img src="assets/img/seaview-dahab.jpg" alt="Room">
                  <span class="cs_card_btn position-absolute cs_zindex_2">
                    <span class="cs_btn cs_style_2 cs_accent_btn cs_medium cs_radius_5 cs_fs_15">
                      <b>Details View</b>
                      <span>
                ...
                <div class="cs_card_info position-relative">
                  ...
                  <div class="cs_card_price cs_mb_17">
                    <span class="cs_primary_color">From</span>
                    <span class="cs_accent_color cs_fs_38 cs_primary_font">EGP3500/Night</span>
                  </div>
                </div>
              </div>
            </div>
